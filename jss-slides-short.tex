...
\title{Recent advances in fast algorithms for optimal changepoint detection}
...
\begin{frame}
  ...
  Benchmark data with 2752 labeled data sequences:
...
\begin{frame}
  \frametitle{Time complexity analysis 1}
...
\begin{frame}
  \frametitle{Time complexity analysis 2}
...
\begin{frame}
  \frametitle{Empirical timings}

  \includegraphics[width=0.8\textwidth]{figure-fullpath-db-binseg}

  Faster than previous quadratic algorithm.
...
\begin{frame}
  ...
  \includegraphics[width=0.8\textwidth]{figure-fullpath-grid-timing}
