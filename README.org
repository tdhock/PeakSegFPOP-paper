PeakSeg Functional Pruning Optimal Partitioning paper
...
- LaTeX source: [[file:jss-paper.tex]]
- Figure showing that disk-based storage is not much slower than
  memory-based storage. [[file:jss-figure-disk-memory-compare-speed.R]]
- Figure showing that PeakSegFPOP can be used to compute more likely
  models than the default MACS2
  model. [[file:jss-figure-more-likely-models.R]]
- Figure showing that [[file:jss-figure-target-intervals-models.R]]
