...
\author{%
  \name Toby Dylan Hocking \email toby.hocking@nau.edu \\%jmlr:tdhock
  \addr School of Informatics, Computing, and Cyber Systems\\
  Northern Arizona University\\
  Flagstaff, AZ, USA
  \AND
  \name Guillem Rigaill \email guillem.rigaill@inra.fr \\%jmlr:rigaill
  \addr Laboratoire de Math\'ematiques et Mod\'elisation d'Evry (LaMME)\\
  Universit\'e d'Evry Val d'Essonne, INRA\\
  Evry, France
  \AND
  \name Paul Fearnhead \email p.fearnhead@lancaster.ac.uk \\%jmlr:fearnhead
  \addr Department of Mathematics and Statistics\\
  Lancaster University\\
  Lancaster, UK
  \AND
  \name Guillaume Bourque \email guil.bourque@mcgill.ca\\%jmlr:bourque
...
\begin{abstract}
  Peak detection in genomic data involves
  segmenting counts of DNA sequence reads aligned to
...
%Our proposed GPDPA can now be used as an optimal
%alternative to heuristic algorithms, even for large data
%sets. 
% Additionally, for \emph{any} model with $P$ peaks, due to the optimality of the GPDPA, it can be used 
