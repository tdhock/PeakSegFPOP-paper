...
\begin{figure} 
  ...
  \vspace{-1cm} 
  \caption{For models with active equality constraints ($K\in\{7,9\}$
    segments in these data), two different rules are used to define
    peaks. \textbf{Join:} segments adjacent to each equality
