...
\begin{figure}
  ...
  \caption{Distribution of differences in min label error among the
    ...
    \textbf{Top:} the up-down constrained GPDPA is more accurate than
    the unconstrained PDPA.  \textbf{Middle:} the GPDPA with Join rule
    is more accurate than baseline MACS and HMCanBroad methods; it is
    just as accurate as the CDPA. \textbf{Bottom:} the Join rule is
    always at least as accurate as the Ignore rule.}
