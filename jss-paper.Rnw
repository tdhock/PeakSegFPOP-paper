...
changepoints which can lead to more accurate estimates \citep{Maidstone2016}. Several of 
...
our up-down constrained model, this paper provides a fast algorithm
