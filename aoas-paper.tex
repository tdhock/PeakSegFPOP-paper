...
pieces; candidate changepoints) that are used to represent a cost
function. The theoretical maximum number of intervals is $I=O(n)$,
...
characterize active regions in each sample and cell type
...
data sets we examined are unbalanced (more possible false positives
than false negatives), we observed similar accuracy for some
algorithms in terms of total number of incorrect labels (see
