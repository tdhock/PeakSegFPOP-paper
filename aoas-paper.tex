...
technique of \citet{pruned-dp} so that it can be applied to the constrained minimisation problem (Table~\ref{tab:contribution}). This
...
exist for constrained minimisation problems such as (\ref{eq:reduced})
