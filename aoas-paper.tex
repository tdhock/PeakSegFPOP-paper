...
interpret in terms of peaks (Figure~\ref{fig:data-models}, left). To
...
versa (Figure~\ref{fig:data-models}, right). This constraint ensures
that odd-numbered segments can be interpreted as background, and
