...
background, the PeakSeg model of \citep{HOCKING-PeakSeg} imposes an
...
$K$, it is not guaranteed to find the optimal segmentation in terms of minimizing our segment cost. Second,
