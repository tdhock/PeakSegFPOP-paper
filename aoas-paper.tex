...
find the segmentation with minimal cost \citep{HOCKING-PeakSeg}. Second, the time complexity
...
efficiently computed for constrained problems. For example in reduced
...
A variant of the GPDPA discussed in the previous section
...
constraints $u_2>u_3$ is undefined; 
