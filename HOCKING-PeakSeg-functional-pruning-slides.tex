...
\item Need to store 3 coefficients (\alert{linear}, \alert{log}, \alert{constant}).
  \end{itemize}
  \begin{center} 
    %\includegraphics[width=0.7\textwidth]{figure-PeakSegPDPA-demo-cost-1segments-1data.pdf}
\input{figure-PeakSegPDPA-demo-cost-1segments-1data.tex}
  \end{center}
\end{frame}
...
\item ...
  ...
  \begin{center}
    ...
    \input{figure-PeakSegPDPA-demo-cost-1segments-2data.tex}
    \input{figure-PeakSegPDPA-demo-cost-1segments-3data.tex}
  \end{center}
\end{frame}
...
\item Main novelty/contribution: The min-less operator
  ...
  exactly for every possible mean $\mu$!
    \begin{center}
      ...
      \input{figure-PeakSegPDPA-demo-minlessmore-2segments-2data.tex}
    \end{center}
\end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \vskip -1cm
  \hskip -1cm 
  \input{figure-PeakSegPDPA-demo-mincompare-2segments-2data.tex}
\end{frame}
...
$$
    \begin{center}
      %\includegraphics[width=0.5\textwidth]{figure-PeakSegPDPA-demo-minenv-2segments-3data.pdf}
      \input{figure-PeakSegPDPA-demo-minenv-2segments-3data.tex}
    \end{center}
  \end{itemize}
\end{frame}
...
$$
      ...
      \input{figure-PeakSegPDPA-demo-minenv-2segments-4data.tex}
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{TODO LABELS Test AUC on 7 benchmark data sets}
...
\begin{frame}
  ...
  \input{figure-PDPA-intervals-log-log.tex}
\end{frame}
