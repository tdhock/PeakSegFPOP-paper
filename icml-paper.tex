...
\icmltitlerunning{A generalized pruned dynamic programming algorithm for log-linear time constrained optimal change-point detection}

\begin{document} 

\twocolumn[
\icmltitle{A generalized pruned dynamic programming algorithm for log-linear time constrained optimal change-point detection}
