...
\begin{abstract}
  ...
  genomic data sets, and new constrained maximum likelihood
  segmentation model for peak detection with an efficient inference
  algorithm: constrained dynamic programming. We propose a new Pruned
  Dynamic Programming algorithm We investigate un\-super\-vised and
  super\-vised learning of penalties for the critical model selection
  problem. We show that the super\-vised method has state-of-the-art
  peak detection across all data sets in a benchmark that includes
  both sharp H3K4me3 and broad H3K36me3 patterns.
\end{abstract}
