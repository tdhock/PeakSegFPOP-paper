...
\caption{\label{fig:evaluations} TODO show that to find a zero-error
  model with a number of peaks that increases with $N$, we only need
  to solve a sub-linear number of penalties (so FPOP is faster than
  PDPA).}
\end{figure}
