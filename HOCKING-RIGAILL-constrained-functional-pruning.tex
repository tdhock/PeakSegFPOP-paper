...
TODO: some commentary about PeakSegDP vs coseg feasibility in the
benchmark data set.
...
of minimum train error. But Segmentor has a low false positive and
true positive rate, so it is easy to get a low test error (just pick
the model with the most peaks). But coseg has a significantly higher
AUC, about the same as PeakSegDP.
